...
public class BookServiceImplUnitTestNoDB
{
    ...
    public void save()
    {
        Author a = new Author("Gina", "Russell");
        a.setAuthorid(100);

        Section s = new Section("Fiction");
        s.setSectionid(1);

        Book b = new Book("Java Tales", "9783456782", 2021, s);
        b.getWrotes()
            .add(new Wrote(a, b));
    ...
    public void update()
    {
        ...
        Section s = new Section("Travel");
        s.setSectionid(3);

        Book b = new Book("Java Tales from Japan", "9783456782", 2021, s);
        b.setBookid(5);
        b.getWrotes()
            .add(new Wrote(a, b));
